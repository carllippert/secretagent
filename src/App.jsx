...
export default function () {
  ...
  const using_custom_titlebar =
    !fullscreen && osType === "Windows_NT" && WIN32_CUSTOM_TITLEBAR;
  ...
  useEffect(() => {
    ...
    if (RUNNING_IN_TAURI) {
      ...
      // system tray
      tauri_event
        .listen("system-tray", ({ payload, ...eventObj }) => {
        ...
        .then((new_unlisten) => {
          unlistens.current[thisMountID] = new_unlisten;
        });
    }
        ...
        <AppShell
          ...
          header={
            <Header
              ...
              className={
                `${classes.header} ` +
                (using_custom_titlebar ? classes.headerOverrides : "")
              }
            >
